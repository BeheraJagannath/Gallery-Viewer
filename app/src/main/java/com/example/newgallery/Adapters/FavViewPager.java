...
public class FavViewPager extends PagerAdapter {
    private final LayoutInflater inflater;
    private final Activity activity;
    ArrayList<String> pathList;
    private String from = "";

    public FavViewPager(Activity activity, ArrayList<String> pathList, String from) {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        ImageSlideBinding imageSlideBinding = DataBindingUtil.inflate(inflater, R.layout.image_slide, view, false);
