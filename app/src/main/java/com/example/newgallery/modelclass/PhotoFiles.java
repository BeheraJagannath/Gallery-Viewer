...
public class PhotoFiles implements Parcelable {

    public static final Creator<PhotoFiles> CREATOR = new Creator<PhotoFiles>() {
        @Override
        public PhotoFiles[] newArray(int size) {
            return new PhotoFiles[size];
        }

        @Override
        public PhotoFiles createFromParcel(Parcel in) {
            PhotoFiles file = new PhotoFiles();
            file.id = in.readLong();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PhotoFiles)) return false;

        PhotoFiles file = (PhotoFiles) o;
